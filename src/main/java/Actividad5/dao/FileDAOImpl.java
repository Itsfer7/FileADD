...
public class FileDAOImpl implements FileDAO {
    ...
    @Override
    public RandomAccessFile insertIntegerIntoFileIntoGivenPosition(RandomAccessFile file, Integer requestPosition, Integer newInt) throws FileNotFoundException {
